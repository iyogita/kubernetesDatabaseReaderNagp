...
- **Docker Image URL:** [Docker Image](https://hub.docker.com/layers/iyogita/demo-app/3.0/images/sha256-7664c768de0cdbc1f27d4efb30e44b288a0d3761840a8818449e94327803cce6?context=repo) (These are related java application images)
...
The Kubernetes Database Reader (Nagp) is a yaml-based application designed to set up infrastructe for a application to read data from a MySQL database. The data is exposed through a RESTful web service, making it accessible via HTTP requests.
